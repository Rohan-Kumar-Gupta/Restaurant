...
router.post("/addGalleryHeading", (req, res) => {
  try {
...
router.put("/updateGalleryHeading/:id", (req, res) => {
  const GalleryHeadingdata = req.body;
...
router.delete("/delGalleryHeading/:id", (req, res) => {
...
router.post("/addGalleryImg", (req, res) => {
...
router.put("/updateGalleryImg/:id", (req, res) => {
  const GalleryImagedata = req.body;
...
router.delete("/delGalleryImg/:id", (req, res) => {
